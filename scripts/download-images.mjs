...
export const rewards = [
  ...
  // Tier 3
  {
    ...
    value: "₹150",
    cost: "1500 CP",
    image: "https://images.unsplash.com/photo-1516908205727-40afad9449a0?auto=format&fit=crop&w=800&q=80"
  },
  {
    id: 10,
    tier: "Tier 3",
  ...
  },
  {
    ...
    value: "₹300",
    cost: "3000 CP",
    image: "https://images.unsplash.com/photo-1559302504-64aae6ca6b6?auto=format&fit=crop&w=800&q=80"
  },
  {
    id: 12,
    tier: "Tier 3",
...
export const testimonials = [
  { name: 'Priya Sharma', role: 'Volunteer', avatar: 'https://i.pravatar.cc/150?img=25', text: 'CivicPlay turned my weekends into meaningful missions. I earned rewards while cleaning my own neighbourhood!' },
  { name: 'Marcus Lee', role: 'Team Lead', avatar: 'https://i.pravatar.cc/150?img=13', text: 'The gamification is genius. My whole office now competes on the leaderboard for a greener city.' },
  { name: 'Ana Gomez', role: 'Student', avatar: 'https://i.pravatar.cc/150?img=44', text: 'I never thought reporting garbage could be this satisfying. The AI verification is lightning fast.' },
  { name: 'Tomás Rivera', role: 'City Official', avatar: 'https://i.pravatar.cc/150?img=52', text: 'Since adopting CivicPlay, citizen reports increased 4x. It is transforming how our city responds.' },
];
...
export const timeline = [
  { year: '2021', title: 'The Idea', desc: 'Born from a hackathon to make civic action addictive.' },
  { year: '2022', title: 'First City', desc: 'Launched pilot with 5,000 active citizens.' },
  { year: '2023', title: 'AI Verification', desc: 'Introduced smart image recognition at scale.' },
  { year: '2024', title: '40+ Cities', desc: 'Expanded across the country with 98K+ users.' },
  { year: '2025', title: 'Global Vision', desc: 'Building the world’s largest civic engagement network.' },
];